...
help:
	...
	@echo "  make reports							  View pixel tracking reports"
	@echo "  make view-reports					   View detailed tracking reports (JSON)"
	@echo "  make clear-tracking					   Clear tracking database (with confirmation)"
	@echo "  make clear-tracking-force				  Clear tracking database (no confirmation)"
	@echo ""
